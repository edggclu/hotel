...
public class ReservasView extends JFrame {
    ...
    public static JTextField txtSimbolo;
    ...
    public ReservasView() {
        ...
        txtSimbolo.setBackground(SystemColor.text);
        txtSimbolo.setBounds(78,328,43,33);
        txtSimbolo.setForeground(Color.gray);
    ...
    private void calcularValor(JDateChooser fechaE, JDateChooser fechaS){
        if(fechaE.getDate() != null && fechaS.getDate() != null){
            ...
            valor = dias * diaria;
            valorTotal = Integer.toString(valor);
            if(valorTotal.equals("-500") || valorTotal.equals("0")){
                txtValor.setForeground(SystemColor.RED);
                txtValor.setText("---------");
            } else {
                txtValor.setForeground(SystemColor.BLACK);
