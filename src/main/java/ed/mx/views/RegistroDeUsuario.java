...
public class RegistroDeUsuario extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    RegistroDeUsuario frame = new RegistroDeUsuario();
    ...
    public RegistroDeUsuario() {
        ...
        imgHotel.setIcon(new ImageIcon(RegistroDeUsuario.class.getResource("/imagenes/img-hotel-login-.png")));
        ...
        JLabel lblNewLabel = new JLabel("REGISTARSE");
        ...
        lblNewLabel_1.setIcon(new ImageIcon(RegistroDeUsuario.class.getResource("/imagenes/lOGO-50PX.png")));
