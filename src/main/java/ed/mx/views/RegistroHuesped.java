...
public class RegistroHuesped extends JFrame {
    ...
    private DefaultComboBoxModel<java.text.Format> yo;
    private EntityManager em;
    Reserva reservaForHuesped;
...
//					frame.setVisible(true);
    ...
    public RegistroHuesped(Reserva reservaForHuesped, EntityManager em) {
        ...
        txtNreserva.setText(reservaForHuesped.getId().toString());
    ...
    private void guardarHuesped() {
        ...
        Object nacionalidad = txtNacionalidad.getSelectedItem();
        String telefono = txtTelefono.getText();
        HuespedesController huespedesController = new HuespedesController();
        Huesped nuevoHuesped = new Huesped(nombre,
                apellido,
